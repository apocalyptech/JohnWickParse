...
impl USoundWave {
    pub(super) fn new(reader: &mut ReaderCursor, name_map: &NameMap, import_map: &ImportMap, asset_file_size: i32, export_size: i64, ubulk: &mut Option<ReaderCursor>, export_idx: u32) -> ParserResult<Self> {
        let super_object = UObject::new(reader, name_map, import_map, "SoundWave", export_idx)?;
